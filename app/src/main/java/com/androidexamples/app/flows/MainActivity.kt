...
import com.androidexamples.app.flows.animations.activityAnimations.AnimationsActivity
import com.androidexamples.app.flows.broadcastReceiver.BroadcastReceiverActivity
import com.androidexamples.app.flows.fragments.FragmentsActivity
import com.androidexamples.app.flows.gestures.GesturesActivity
import com.androidexamples.app.flows.handlers.HandlerAsyncTaskActivity
import com.androidexamples.app.flows.notifications.NotificationsActivity
import com.androidexamples.app.flows.toolbar.ActionBarToolbarActivity
import com.androidexamples.app.flows.viewpager.ViewPagerActivity
import com.androidexamples.app.flows.views.OtherViewsActivity
    ...
    private fun onButtonClickListener(): View.OnClickListener {
        return View.OnClickListener { v ->
            when (v.id) {
                ...
                R.id.button_another_views -> startActivity(Intent(baseContext, OtherViewsActivity::class.java))
